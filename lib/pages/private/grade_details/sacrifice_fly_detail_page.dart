...
class SacrificeFlyDetailPage extends StatefulWidget {
  ...
  @override
  State<SacrificeFlyDetailPage> createState() => _SacrificeFlyDetailPageState();
}

class _SacrificeFlyDetailPageState extends State<SacrificeFlyDetailPage> {
  ...
  void _setFilterDates() {
    ...
    if (selectedPeriodFilter == '通算') {
      ...
      // If year is selected, _startDate and _endDate should already be set when tapping the year button.
      // Do nothing here.
    } else {
  ...
  @override
  void didUpdateWidget(SacrificeFlyDetailPage oldWidget) {

...
class PitchingDetailPage extends StatefulWidget {
  ...
  @override
  _PitchingDetailPageState createState() => _PitchingDetailPageState();
}

class _PitchingDetailPageState extends State<PitchingDetailPage> {
  ...
  @override
  void didUpdateWidget(covariant PitchingDetailPage oldWidget) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<Map<String, dynamic>?>(
        ...
        builder: (context, snapshot) {
          ...
          final totalAppearances = stats['totalAppearances'] ?? 0;

...
class TeamBattedBallDetail extends StatefulWidget {
  final String teamId;
  ...
  @override
  State<TeamBattedBallDetail> createState() => _TeamBattedBallDetailState();
}

class _TeamBattedBallDetailState extends State<TeamBattedBallDetail> {
  ...
  @override
  void didUpdateWidget(TeamBattedBallDetail oldWidget) {

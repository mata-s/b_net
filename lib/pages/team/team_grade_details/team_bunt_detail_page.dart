...
class TeamBuntDetailPage extends StatefulWidget {
  final String teamId;
  ...
  @override
  _TeamBuntDetailPageState createState() => _TeamBuntDetailPageState();
}

class _TeamBuntDetailPageState extends State<TeamBuntDetailPage> {
  ...
  @override
  void didUpdateWidget(covariant TeamBuntDetailPage oldWidget) {

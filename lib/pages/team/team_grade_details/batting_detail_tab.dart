import 'package:b_net/pages/team/team_grade_details/team_bunt_detail_page.dart';
import 'package:b_net/pages/team/team_grade_details/team_sacrifice_fly_detail_page.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class BattingDetailTab extends StatefulWidget {
  final String teamId;
  ...
  @override
  State<BattingDetailTab> createState() => _BattingDetailTabState();
}

class _BattingDetailTabState extends State<BattingDetailTab> {
  ...
  @override
  void didUpdateWidget(covariant BattingDetailTab oldWidget) {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  _buildStatColumn('ISO',
                                      formatAverage(adv['iso'] ?? 0), 80),
                                  _buildStatColumn('BABI',
                                      formatAverage(adv['babip'] ?? 0), 80),
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      mainAxisAlignment:
                                          MainAxisAlignment.spaceAround,
                                      children: [
                                        _buildStatColumn('スイング数',
                                            swingCount?.toString() ?? '0', 60),
                                        _buildStatColumn(
                                            '空振り数',
                                            missSwingCount?.toString() ?? '0',
                                            60),
                                      ],
                                    ),
                                    const SizedBox(height: 15),

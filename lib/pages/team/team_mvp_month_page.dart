...
class TeamMvpMonthPage extends StatefulWidget {
  final String teamId;

  const TeamMvpMonthPage({Key? key, required this.teamId}) : super(key: key);

  @override
  State<TeamMvpMonthPage> createState() => _TeamMvpMonthPageState();
}

class _TeamMvpMonthPageState extends State<TeamMvpMonthPage>
  ...
  void _showMonthPicker(Function(DateTime) onSelected) {
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  TextButton(
                    onPressed: () {
                      onSelected(DateTime(tempYear, tempMonth));
                ...
                children: [
                  ...
                  Expanded(
                    child: CupertinoPicker(
                      ...
                      children: List.generate(12, (i) => Text('${i + 1}月')),
                    ),
                  ),
                ],
              ),
